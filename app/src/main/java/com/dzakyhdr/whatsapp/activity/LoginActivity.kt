...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTextChangedLsitener(edt_email, til_email)
        setTextChangedLsitener(edt_password, til_password)
    ...
    private fun setTextChangedLsitener(edt: EditText, til: TextInputLayout) {
